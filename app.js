...
const productosPorCategoria = {
    'bebidas-calientes': [
        ...
        { nombre: 'Capuccino', precio: 4.50,imagen: './images/bebidasCalientes/capucchino.jpg' },
...
function cargarProductos(categoria) {
    ...
    productosDiv.innerHTML = ''; // Limpiamos productos anteriores
...
function actualizarResumenCarrito() {
    ...
    listaCarritoDiv.innerHTML = ''; // Limpiamos el contenido anterior
